...
import { decodeKeypath, encodeKeypath } from './cosmwasm.js';
...
describe('CosmWasm', () => {
  test('encodeKeypath', () => {
    ...
    expect(toHex(encodeKeypath(['nft_stakes', 'terra123...']))).toEqual('000a6e66745f7374616b657374657272613132332e2e2e');
    expect(toHex(encodeKeypath(['nb', '0']))).toEqual('00026e6230');
  ...
  test('decodeKeypath', () => {
    ...
    expect(decodeKeypath(fromHex('000a6e66745f7374616b657374657272613132332e2e2e'))).toEqual(['nft_stakes', 'terra123...']);
    expect(decodeKeypath(fromHex('00026e6230'))).toEqual(['nb', '0']);
